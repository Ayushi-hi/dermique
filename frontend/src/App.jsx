...
const VERDICT_META = {
  ...
  'Good Match':  { bg: 'rgba(201,168,76,0.1)',   fg: '#c9a84c', br: 'rgba(201,168,76,0.28)'  },
  'Neutral':     { bg: 'rgba(255,255,255,0.04)', fg: 'rgba(255,255,255,0.5)', br: 'rgba(255,255,255,0.1)' },
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        <div>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 18, fontWeight: 600, color: '#f5e6b8', letterSpacing: '4px' }}>DERMIQUÉ</div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 36 }}>
        {[
          ...
          <span key={id}
            ...
            style={{ fontFamily: 'var(--font-body)', fontSize: 11, color: 'rgba(255,255,255,0.45)', letterSpacing: '2px', textTransform: 'uppercase', transition: 'color 0.2s', pointerEvents: 'all' }}
        ...
        <button onClick={onScanClick} style={{
          ...
          color: '#080808', background: 'linear-gradient(135deg,#c9a84c,#e4c46a)',
    ...
    <section style={{
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: 820 }}>
        ...
        <div style={{
          ...
          <span style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: '#c9a84c', letterSpacing: '4px', textTransform: 'uppercase' }}>The Science of Flawless Skin</span>
        ...
        <h1 style={{
          ...
          color: 'var(--goldPale)', letterSpacing: '6px',
          marginBottom: 12,
        ...
        <h2 style={{
          ...
          fontSize: 'clamp(22px,3.5vw,42px)', color: 'rgba(255,255,255,0.6)',
        ...
        <p style={{
          ...
          color: 'rgba(255,255,255,0.52)', lineHeight: 1.9, maxWidth: 620, margin: '0 auto 52px',
          opacity: mounted ? 1 : 0, transform: mounted ? 'translateY(0)' : 'translateY(16px)',
        ...
        <div style={{
          ...
          {[
            ...
            { n: 'GPT-4o', l: 'Vision Analysis' },
            { n: '8', l: 'Skin Profiles' },
            { n: '<8s', l: 'Per Analysis' },
          ].map(s => (
            <div key={s.l} style={{ textAlign: 'center' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 18, color: '#c9a84c', letterSpacing: '2px' }}>{s.n}</div>
              <div style={{ fontFamily: 'var(--font-body)', fontSize: 9, color: 'rgba(255,255,255,0.35)', letterSpacing: '2px', textTransform: 'uppercase', marginTop: 4 }}>{s.l}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ position: 'absolute', bottom: 36, left: '50%', transform: 'translateX(-50%)', opacity: 0.4 }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: 9, color: '#c9a84c', letterSpacing: '3px', textTransform: 'uppercase', marginTop: 10 }}>Scroll</div>
      </div>
    </section>
  )
}
    ...
    <section id="method" style={{ padding: '120px 48px', background: 'var(--onyx)', borderTop: '1px solid rgba(201,168,76,0.08)', borderBottom: '1px solid rgba(201,168,76,0.08)' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2, marginTop: 64 }}>
          {[
            {
              n: 'I', title: 'Profile Your Skin',
              desc: 'Select from eight clinically-defined skin profiles. Every analysis is calibrated to your specific skin biology — not a generic assessment.',
              icon: (
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                  <circle cx="22" cy="18" r="7" stroke="#c9a84c" strokeWidth="1"/>
                  <path d="M8 38C8 30 36 30 36 38" stroke="#c9a84c" strokeWidth="1" strokeLinecap="round"/>
                  <circle cx="22" cy="18" r="2.5" fill="#c9a84c" opacity="0.4"/>
                </svg>
              )
            },
            {
              n: 'II', title: 'Scan the Label',
              desc: 'Photograph the INCI ingredient list or barcode of any skincare product. Our GPT-4o vision model reads it with pharmaceutical precision.',
              icon: (
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                  <rect x="4" y="4" width="14" height="14" rx="2" stroke="#c9a84c" strokeWidth="1"/>
                  <rect x="26" y="4" width="14" height="14" rx="2" stroke="#c9a84c" strokeWidth="1"/>
                  <rect x="4" y="26" width="14" height="14" rx="2" stroke="#c9a84c" strokeWidth="1"/>
                  <rect x="28" y="28" width="4" height="4" fill="#c9a84c" opacity="0.5"/>
                  <path d="M34 26v6M26 34h6M34 34h6v6" stroke="#c9a84c" strokeWidth="1" strokeLinecap="round"/>
                </svg>
              )
            },
            {
              n: 'III', title: 'Receive Your Report',
              desc: 'A luxury-grade safety report: harmful ingredients flagged, beneficial actives celebrated, and a bespoke recommendation written for your skin.',
              icon: (
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                  <rect x="8" y="4" width="28" height="36" rx="3" stroke="#c9a84c" strokeWidth="1"/>
                  <path d="M15 16h14M15 22h14M15 28h9" stroke="#c9a84c" strokeWidth="1" strokeLinecap="round"/>
                  <circle cx="33" cy="33" r="8" fill="#0f0f0f" stroke="#7ab68a" strokeWidth="1"/>
                  <path d="M29.5 33l2.5 2.5 5-5" stroke="#7ab68a" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              )
            }
          ].map((s, i) => (
            <div key={i} style={{
              padding: '52px 44px', background: i === 1 ? 'rgba(201,168,76,0.04)' : 'transparent',
              border: '1px solid rgba(201,168,76,0.1)', borderLeft: i > 0 ? '1px solid rgba(201,168,76,0.1)' : '1px solid rgba(201,168,76,0.1)',
              position: 'relative', transition: 'background 0.3s ease',
            }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(201,168,76,0.06)'}
              onMouseLeave={e => e.currentTarget.style.background = i === 1 ? 'rgba(201,168,76,0.04)' : 'transparent'}
            >
              ...
              <p style={{ fontFamily: 'var(--font-reading)', fontSize: 15, color: 'var(--textMid)', lineHeight: 1.9 }}>{s.desc}</p>
              <div style={{ position: 'absolute', top: 52, right: 44, fontFamily: 'var(--font-display)', fontSize: 72, color: 'rgba(201,168,76,0.04)', lineHeight: 1, userSelect: 'none' }}>{s.n}</div>
            </div>
          ))}
        </div>
      </div>
...
function ScannerSection() {
  ...
  const doScan = useCallback(async () => {
    ...
    try {
      // Send to our Node.js backend which calls Anthropic securely
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        {phase === 'idle' && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, marginTop: 64 }}>
            {/* LEFT — Skin selector */}
            <div style={{ padding: '44px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.12)' }}>
              <div style={{ marginBottom: 32 }}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 11, color: '#c9a84c', letterSpacing: '3px', marginBottom: 10 }}>STEP ONE</div>
                <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: 28, fontWeight: 400, color: 'var(--goldPale)', marginBottom: 8 }}>Your Skin Profile</h3>
                <p style={{ fontFamily: 'var(--font-reading)', fontSize: 14, color: 'var(--textDim)', lineHeight: 1.7 }}>Select all skin types that apply to you</p>
              </div>
                ...
                {SKIN_TYPES.map(s => {
                  ...
                  return (
                    <button key={s.id} onClick={() => toggleSkin(s.id)} style={{
                      background: on ? 'rgba(201,168,76,0.1)' : 'rgba(255,255,255,0.02)',
                    ...
                    >
                      ...
                      <div style={{ fontFamily: 'var(--font-serif)', fontSize: 15, fontWeight: 500, color: on ? '#f5e6b8' : 'rgba(255,255,255,0.7)', marginBottom: 3 }}>{s.id}</div>
              ...
              {skins.length > 0 && (
                <div style={{ padding: '14px 18px', background: 'rgba(201,168,76,0.06)', border: '1px solid rgba(201,168,76,0.15)', display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
                  ...
                  {skins.map(id => (
                    <span key={id} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.2)', padding: '3px 10px 3px 12px', fontFamily: 'var(--font-body)', fontSize: 10, color: '#c9a84c', letterSpacing: '0.5px' }}>
                      {id}
            ...
            {/* RIGHT — Upload */}
            <div style={{ padding: '44px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.12)', borderLeft: '1px solid rgba(201,168,76,0.06)', display: 'flex', flexDirection: 'column' }}>
              <div style={{ marginBottom: 32 }}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 11, color: '#c9a84c', letterSpacing: '3px', marginBottom: 10 }}>STEP TWO</div>
                <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: 28, fontWeight: 400, color: 'var(--goldPale)', marginBottom: 8 }}>Upload Product</h3>
                <p style={{ fontFamily: 'var(--font-reading)', fontSize: 14, color: 'var(--textDim)', lineHeight: 1.7 }}>Ingredient label or barcode photograph</p>
              </div>
              ...
              {!preview ? (
                <div
                  ...
                  style={{
                    ...
                    border: `1px dashed ${drag ? '#c9a84c' : 'rgba(201,168,76,0.22)'}`,
                    background: drag ? 'rgba(201,168,76,0.06)' : 'rgba(255,255,255,0.01)',
                    display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
                    gap: 16, cursor: 'none', transition: 'all 0.2s ease',
                    position: 'relative', overflow: 'hidden',
                  }}
                  onMouseEnter={e => { e.currentTarget.style.border = '1px dashed rgba(201,168,76,0.5)'; e.currentTarget.style.background = 'rgba(201,168,76,0.03)' }}
                  onMouseLeave={e => { if (!drag) { e.currentTarget.style.border = '1px dashed rgba(201,168,76,0.22)'; e.currentTarget.style.background = 'rgba(255,255,255,0.01)' }}}
                >
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontFamily: 'var(--font-serif)', fontSize: 18, color: 'rgba(255,255,255,0.5)', marginBottom: 6 }}>Drop your product image</div>
                    <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: 'var(--textFaint)', letterSpacing: '1px' }}>INCI LABEL · BARCODE · JPG PNG WEBP</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ height: 1, width: 32, background: 'rgba(201,168,76,0.15)' }}/>
                    <span style={{ fontFamily: 'var(--font-body)', fontSize: 9, color: 'var(--textFaint)', letterSpacing: '2px' }}>OR</span>
                    <div style={{ height: 1, width: 32, background: 'rgba(201,168,76,0.15)' }}/>
                  </div>
                  <button onClick={e => { e.stopPropagation(); fileRef.current.click() }} style={{
                    fontFamily: 'var(--font-display)', fontSize: 9, letterSpacing: '2.5px',
                    color: '#c9a84c', background: 'transparent', border: '1px solid rgba(201,168,76,0.35)',
                    padding: '10px 24px', cursor: 'none', transition: 'all 0.2s',
                  }}
                ...
                <div style={{ position: 'relative', flex: 1 }}>
                  <img src={preview} alt="Preview" style={{ width: '100%', height: 220, objectFit: 'contain', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.15)', display: 'block' }}/>
                  <button onClick={() => { setFile(null); setPreview(null) }} style={{
                    position: 'absolute', top: 10, right: 10, background: 'rgba(8,8,8,0.8)', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.6)', padding: '5px 12px', fontSize: 11, fontFamily: 'var(--font-body)', cursor: 'none', transition: 'all 0.2s',
                  }}>Remove</button>
                </div>
              )}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, margin: '16px 0' }}>
                {[['Good lighting','No shadows or glare'],['Label visible','INCI list fully in frame'],['Barcode flat','No curled edges'],['Sharp focus','No motion blur']].map(([t,s]) => (
                  <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <div style={{ width: 4, height: 4, borderRadius: '50%', background: '#c9a84c', opacity: 0.5, flexShrink: 0 }}/>
                    <div>
                      <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.5px' }}>{t}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <button disabled={!canScan} onClick={doScan} style={{
                ...
                background: canScan ? 'linear-gradient(135deg,#c9a84c,#e4c46a)' : 'rgba(255,255,255,0.04)',
        ...
        {phase === 'scanning' && (
          <div style={{ marginTop: 64, display: 'flex', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center', maxWidth: 480, padding: '64px 48px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.12)' }}>
              {preview && (
                <div style={{ width: 88, height: 88, borderRadius: '50%', overflow: 'hidden', margin: '0 auto 36px', border: '1px solid rgba(201,168,76,0.3)', position: 'relative' }}>
                  ...
                  <div style={{ position: 'absolute', inset: 0, background: 'rgba(201,168,76,0.1)', animation: 'scanPulse 1.8s ease-in-out infinite' }}/>
                </div>
              )}
              <ScannerSpinner />
              ...
              <p style={{ fontFamily: 'var(--font-reading)', fontSize: 15, color: 'var(--textDim)', marginBottom: 40, lineHeight: 1.7 }}>Cross-referencing with your {skins.join(' · ')} profile</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, textAlign: 'left' }}>
                {['Reading ingredient label','Extracting INCI compound list','Cross-referencing dermatological data','Composing your personalised report'].map((s, i) => (
                  <div key={s} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '12px 18px', background: 'rgba(201,168,76,0.04)', border: '1px solid rgba(201,168,76,0.08)' }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--textMid)', letterSpacing: '0.5px' }}>{s}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        {phase === 'error' && (
          <div style={{ marginTop: 64, display: 'flex', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center', maxWidth: 440, padding: '64px 48px', background: 'rgba(196,112,96,0.04)', border: '1px solid rgba(196,112,96,0.2)' }}>
              ...
              <p style={{ fontFamily: 'var(--font-reading)', fontSize: 15, color: 'var(--textDim)', marginBottom: 36, lineHeight: 1.75 }}>{errMsg}</p>
  ...
  return (
    <div style={{ marginTop: 64, animation: 'fadeUp 0.6s ease both' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 2, marginBottom: 2 }}>
        ...
        {/* Product card */}
        <div style={{ padding: '40px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.12)', position: 'relative', overflow: 'hidden', boxShadow: `0 0 60px ${safeData.glow}` }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 24, position: 'relative' }}>
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--textDim)', letterSpacing: '1px', marginBottom: 20 }}>{result.brand}</p>
              ...
              <p style={{ fontFamily: 'var(--font-reading)', fontSize: 14, color: 'var(--textMid)', lineHeight: 1.85, maxWidth: 440 }}>{result.summary}</p>
            </div>
            {preview && (
        ...
        {/* Score donut */}
        <div style={{ padding: '40px 36px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.12)', borderLeft: 'none', textAlign: 'center', minWidth: 164 }}>
          ...
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 8, color: 'var(--textFaint)', letterSpacing: '2.5px', textTransform: 'uppercase', marginTop: 4, marginBottom: 12 }}>Safety Score</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <div style={{ padding: '28px 32px', background: verdData.bg, border: `1px solid ${verdData.br}` }}>
            ...
            <p style={{ fontFamily: 'var(--font-reading)', fontSize: 14, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, marginBottom: 12 }}>{result.skinTypeNote}</p>
          ...
          {result.keyIngredients?.length > 0 && (
            <div style={{ padding: '28px 32px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.1)' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 7 }}>
                {result.keyIngredients.map(k => (
                  <span key={k} style={{ fontFamily: 'var(--font-reading)', fontStyle: 'italic', fontSize: 13, color: '#c9a84c', background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.18)', padding: '5px 14px' }}>{k}</span>
                ))}
              </div>
            </div>
          )}
          ...
          {/* Recommendation */}
          <div style={{ padding: '28px 32px', background: 'rgba(201,168,76,0.04)', border: '1px solid rgba(201,168,76,0.12)', flex: 1 }}>
            ...
            <p style={{ fontFamily: 'var(--font-reading)', fontSize: 15, color: 'rgba(255,255,255,0.65)', lineHeight: 1.9 }}>{result.recommendation}</p>
          </div>
          ...
          {result.certifications?.length > 0 && (
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
              {result.certifications.map(c => (
                <span key={c} style={{ fontFamily: 'var(--font-body)', fontSize: 9, color: 'var(--textDim)', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', padding: '5px 12px', letterSpacing: '1px' }}>✓ {c}</span>
              ))}
            </div>
          )}
        </div>
        ...
        {/* Right col — tabs */}
        <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(201,168,76,0.1)', display: 'flex', flexDirection: 'column' }}>
          {/* Tab bar */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', borderBottom: '1px solid rgba(201,168,76,0.1)' }}>
            {[
              ...
              <button key={t.id} onClick={() => setTab(t.id)} style={{
                background: tab === t.id ? `${t.c}0d` : 'transparent',
                border: 'none', borderBottom: tab === t.id ? `2px solid ${t.c}` : '2px solid transparent',
                padding: '18px 8px', cursor: 'none', transition: 'all 0.2s',
              }}>
                ...
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 28, color: tab === t.id ? t.c : 'rgba(255,255,255,0.1)' }}>{t.count}</div>
              </button>
            ))}
          </div>
            ...
            {(() => {
              ...
              if (!items.length) return (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 0', gap: 12, opacity: 0.4 }}>
                  ...
                  <p style={{ fontFamily: 'var(--font-body)', fontSize: 11, color: 'var(--textDim)', letterSpacing: '1px' }}>{tab === 'good' ? 'No beneficial ingredients identified' : 'None found'}</p>
                </div>
              )
                ...
                <div key={i} style={{ display: 'flex', gap: 12, padding: '13px 10px', borderBottom: '1px solid rgba(255,255,255,0.04)', borderLeft: `2px solid ${item.c}50` }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 5 }}>
                      <span style={{ fontFamily: 'var(--font-serif)', fontSize: 15, fontWeight: 500, color: 'rgba(255,255,255,0.85)' }}>{item.name}</span>
                    ...
                    <p style={{ fontFamily: 'var(--font-reading)', fontSize: 12, color: 'var(--textDim)', lineHeight: 1.7 }}>{item.desc}</p>
                  </div>
                </div>
              ))
            })()}
  ...
  return (
    <section id="promise" style={{ padding: '120px 48px', background: 'var(--charcoal)', borderTop: '1px solid rgba(201,168,76,0.08)', borderBottom: '1px solid rgba(201,168,76,0.08)' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        <div>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 10, color: '#c9a84c', letterSpacing: '4px', marginBottom: 20 }}>THE DERMIQUÉ PROMISE</div>
          ...
          <p style={{ fontFamily: 'var(--font-reading)', fontSize: 16, color: 'var(--textMid)', lineHeight: 2, marginBottom: 36 }}>
            Over 1,400 chemicals have been found in common skincare products. Many are linked to irritation, hormonal disruption, and long-term barrier damage. DERMIQUÉ was built so that every person — regardless of background or expertise — can make informed decisions about what they apply to their skin.
          </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          {[
            ...
            <div key={s.n} style={{ padding: '28px 32px', background: 'rgba(201,168,76,0.03)', border: '1px solid rgba(201,168,76,0.1)', display: 'flex', gap: 24, alignItems: 'flex-start' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 28, color: '#c9a84c', lineHeight: 1, flexShrink: 0, minWidth: 70 }}>{s.n}</div>
              <div>
                <div style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'rgba(255,255,255,0.7)', letterSpacing: '0.5px', marginBottom: 5 }}>{s.l}</div>
                <div style={{ fontFamily: 'var(--font-reading)', fontStyle: 'italic', fontSize: 13, color: 'var(--textDim)' }}>{s.desc}</div>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <section id="ingredients" style={{ padding: '120px 48px', background: 'var(--obsidian)' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2, marginTop: 64 }}>
          {[
            { color: '#c47060', glow: 'rgba(196,112,96,0.12)', label: 'FLAGGED', title: 'Harmful Compounds', desc: 'Parabens, synthetic fragrances, SLS, PFAS, formaldehyde releasers, and other substances with documented links to skin irritation, hormonal disruption, or barrier damage. These are listed with severity ratings.' },
            { color: '#d4a855', glow: 'rgba(212,168,85,0.12)',  label: 'MONITOR',  title: 'Caution Ingredients', desc: 'Compounds that are broadly safe but may not suit every skin type. Denatured alcohols, high-concentration exfoliants, and sensitising preservatives fall here — contextualised to your profile.' },
            { color: '#7ab68a', glow: 'rgba(122,182,138,0.12)', label: 'BENEFICIAL', title: 'Active Ingredients', desc: 'Niacinamide, hyaluronic acid, ceramides, retinol, vitamin C, peptides. These are highlighted with explanations of their specific benefits for your skin type.' },
          ].map(c => (
            <div key={c.title} style={{ padding: '44px 40px', background: `${c.glow}`, border: `1px solid ${c.color}22`, borderTop: `2px solid ${c.color}`, position: 'relative', overflow: 'hidden' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 9, color: c.color, letterSpacing: '3px', marginBottom: 22 }}>{c.label}</div>
              <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: 24, fontWeight: 500, color: 'var(--goldPale)', marginBottom: 18, letterSpacing: '0.3px' }}>{c.title}</h3>
              <p style={{ fontFamily: 'var(--font-reading)', fontSize: 14, color: 'var(--textMid)', lineHeight: 1.95 }}>{c.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
function Footer({ onScanClick }) {
  return (
    <footer style={{ background: '#040404', borderTop: '1px solid rgba(201,168,76,0.1)', padding: '72px 48px 40px' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 64 }}>
          <div>
            <div style={{ fontFamily: 'var(--font-display)', fontSize: 20, color: '#f5e6b8', letterSpacing: '4px', marginBottom: 8 }}>DERMIQUÉ</div>
            ...
            <p style={{ fontFamily: 'var(--font-reading)', fontSize: 13, color: 'var(--textDim)', lineHeight: 1.85, maxWidth: 280 }}>
              A luxury intelligence platform dedicated to the transparency of skincare formulation. Know what you put on your skin.
            </p>
          </div>
          {[
            ...
            <div key={col.title}>
              ...
              {col.links.map(l => (
                <div key={l} style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--textDim)', letterSpacing: '0.5px', marginBottom: 12, cursor: 'none', transition: 'color 0.2s' }}
        ...
        {/* CTA strip */}
        <div style={{ padding: '36px 44px', background: 'rgba(201,168,76,0.04)', border: '1px solid rgba(201,168,76,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 32, marginBottom: 48, flexWrap: 'wrap' }}>
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-reading)', fontSize: 13, color: 'var(--textDim)' }}>Scan any product. Free. Instant. Personalised.</p>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 28, borderTop: '1px solid rgba(255,255,255,0.05)', flexWrap: 'wrap', gap: 12 }}>
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: 'var(--textFaint)', letterSpacing: '1px' }}>© 2025 DERMIQUÉ. For informational purposes only.</div>
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: 'var(--textFaint)', letterSpacing: '1px' }}>Powered by GPT-4o Vision Intelligence</div>
        </div>
      </div>
    </footer>
  )
...
function SectionHeader({ label, title, sub }) {
  return (
    <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
      <div style={{ fontFamily: 'var(--font-display)', fontSize: 10, color: '#c9a84c', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: 16 }}>{label}</div>
      ...
      {sub && <p style={{ fontFamily: 'var(--font-reading)', fontSize: 16, color: 'var(--textMid)', lineHeight: 1.85, marginTop: 14 }}>{sub}</p>}
...
function GoldButton({ children, onClick, large }) {
  return (
    <button onClick={onClick} style={{
      fontFamily: 'var(--font-display)', fontSize: large ? 12 : 10, letterSpacing: '2.5px',
      color: '#080808', background: 'linear-gradient(135deg,#c9a84c,#e4c46a)',
      border: 'none', padding: large ? '18px 52px' : '14px 36px', cursor: 'none',
      boxShadow: '0 4px 22px rgba(201,168,76,0.28)', transition: 'all 0.25s ease',
    }}
...
function OutlineButton({ children, onClick }) {
  return (
    <button onClick={onClick} style={{
      fontFamily: 'var(--font-display)', fontSize: 10, letterSpacing: '2.5px',
      color: 'rgba(255,255,255,0.55)', background: 'transparent',
      border: '1px solid rgba(255,255,255,0.14)', padding: '14px 36px', cursor: 'none',
